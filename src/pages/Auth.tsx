...
export default function Auth() {
  ...
  useEffect(() => {
    const checkForAuthRedirect = async () => {
      // Check if we're in a redirect flow from OAuth
      ...
      if (accessToken) {
        ...
        // If we have an access token, we're in the OAuth callback
        // The token will be handled by Supabase auth listener in AuthContext
        toast({
          title: "Authentication successful",
          description: "You are being redirected to the dashboard...",
        });
        
        // Clear the URL hash to avoid issues with future navigation
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        // Don't reset isProcessingOAuth here - we'll wait for the redirect
      }
    } catch (error: any) {
