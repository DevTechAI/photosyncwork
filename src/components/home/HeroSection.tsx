...
export function HeroSection() {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-4 relative bg-gradient-to-br from-dustyBlue-whisper via-warmWhite to-sage-light">
      {/* Logo */}
      <div 
      ...
      <div className="absolute bottom-16 left-0 right-0 px-4 md:px-8 overflow-hidden">
        <div className="flex flex-col md:flex-row justify-between items-center gap-3 md:gap-8 max-w-xs md:max-w-7xl mx-auto relative">
          ...
          <Button 
            ...
            variant="outline" 
            className={`group h-9 md:h-10 w-full md:w-auto px-4 md:px-6 py-2 border-2 text-xs md:text-sm transition-all duration-700 ease-in-out overflow-hidden bg-dustyBlue-whisper/50 backdrop-blur-sm hover:bg-dustyBlue-soft hover:shadow-lg ${
          ...
          >
            ...
            <span className="font-medium font-playfair">Client Portal</span>
          </Button>
          ...
          <Button 
            ...
            variant="outline" 
            className={`group h-9 md:h-10 w-full md:w-auto px-4 md:px-6 py-2 border-2 text-xs md:text-sm transition-all duration-700 ease-in-out overflow-hidden md:absolute md:left-1/2 md:transform md:-translate-x-1/2 bg-dustyBlue-whisper/50 backdrop-blur-sm hover:bg-dustyBlue-soft hover:shadow-lg ${
          ...
          >
            ...
            <span className="font-medium font-playfair">Photographers Portal</span>
          </Button>
          ...
          >
            ...
            <span className="font-medium font-playfair">Hire a Teammate</span>
          </Button>
        </div>
      </div>
      ...
      >
        <div className="w-5 h-8 md:w-6 md:h-10 border-2 rounded-full flex justify-center" style={{ borderColor: 'hsl(var(--dusty-blue))' }}>
